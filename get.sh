...
#   Usage:
#
#   	$ curl -fsSL https://raw.githubusercontent.com/marcisgi/get/master/get.sh | bash
#   	  or
#   	$ wget -qO- https://raw.githubusercontent.com/marcisgi/get/master/get.sh | bash
#
...
install_filemanager()
{
	...
	*)
	...
	filemanager_tag="$(${net_getter}  https://api.github.com/repos/marcisgi/filebrowser/releases/latest | grep -o '"tag_name": ".*"' | sed 's/"//g' | sed 's/tag_name: //g')"
	filemanager_url="https://github.com/marcisgi/filebrowser/releases/download/$filemanager_tag/$filemanager_file"
